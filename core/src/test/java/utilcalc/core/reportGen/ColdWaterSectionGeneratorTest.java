...
public class ColdWaterSectionGeneratorTest {
    ...
    void coldWaterSection_withOneMeterId_should_haveCorrectColdWaterReading() {
        ...
        ColdWaterSection coldWaterSection = generateColdWaterSection(
                createDateRange("2024-01-01", "2025-01-01"),
                createColdWaterSectionInputs(
                        List.of(waterTariff), List.of(meterReading1, meterReading2, meterReading3)));
    ...
    @Test
    void coldWaterSection_withOneMeterId_withOutOfReportReadings_should_haveCorrectColdWaterReading() {
    ...
    @Test
    void coldWaterSection_withOneMeterId_withOutOfReportStartReading_should_haveCorrectColdWaterReading() {
        MeterReading meterReading1 = createMeterReading("kitchen", "2023-12-01", "100");
        MeterReading meterReading2 = createMeterReading("kitchen", "2024-06-01", "125");
        MeterReading meterReading3 = createMeterReading("kitchen", "2025-01-01", "150");
    ...
    @Test
    void coldWaterSection_withOneMeterId_withOutOfReportEndReading_should_haveCorrectColdWaterReading() {
        MeterReading meterReading1 = createMeterReading("kitchen", "2024-01-01", "100");
        MeterReading meterReading2 = createMeterReading("kitchen", "2024-06-01", "125");
        MeterReading meterReading3 = createMeterReading("kitchen", "2025-02-01", "150");
    ...
    void coldWaterSection_withReplaceMeter_should_haveCorrectColdWaterReading() {
        ...
        ColdWaterSection coldWaterSection = generateColdWaterSection(
                createDateRange("2024-01-01", "2025-01-01"),
                createColdWaterSectionInputs(
                        List.of(waterTariff), List.of(meterReading1, meterReading2, meterReading3, meterReading4)));
    ...
    @Test
    void coldWaterSection_withMultipleMeters_withMisingReadings_should_haveCorrectColdWaterReading() {
        MeterReading meterReading1 = createMeterReading("kitchen", "2024-01-01", "100");
        MeterReading meterReading2 = createMeterReading("kitchen", "2024-06-01", "125");
        ...
        assertThat(waterReading3.dateRange()).isEqualTo(createDateRange("2024-01-01", "2024-06-01"));
        ...
        assertThat(waterReading4.dateRange()).isEqualTo(createDateRange("2024-06-01", "2025-01-01"));
    ...
    void coldWaterSection_withOneMeterId_withMultipleTariff_should_haveCorrectColdWaterFee() {
        ...
        ColdWaterSection coldWaterSection = generateColdWaterSection(
                createDateRange("2024-01-01", "2025-01-01"),
                createColdWaterSectionInputs(
                        List.of(waterTariff2, waterTariff1), List.of(meterReading2, meterReading1, meterReading3)));
        ...
        assertThat(coldWaterFee1.dateRange()).isEqualTo(createDateRange("2024-01-01", "2024-06-01"));
        ...
        assertThat(coldWaterFee2.dateRange()).isEqualTo(createDateRange("2024-06-01", "2025-01-01"));
    ...
    @Test
    void coldWaterSection_withMultipleMeters_withMisingReadings_withMultipleTariff_should_haveCorrectColdWaterFee() {
        MeterReading meterReading1 = createMeterReading("kitchen", "2024-01-01", "100");
        MeterReading meterReading2 = createMeterReading("kitchen", "2024-06-01", "125");
        MeterReading meterReading3 = createMeterReading("bathroom", "2024-01-01", "0");
        MeterReading meterReading4 = createMeterReading("bathroom", "2024-06-01", "30");
    ...
    @Test
    void coldWaterSection_withOneMeterId_withMultipleTariff_withMisingTariffZone_should_haveCorrectColdWaterFee() {
        MeterReading meterReading1 = createMeterReading("kitchen", "2024-01-01", "100");
        MeterReading meterReading2 = createMeterReading("kitchen", "2024-06-01", "125");
        MeterReading meterReading3 = createMeterReading("kitchen", "2025-01-01", "150");

        WaterTariff waterTariff1 = createWaterTariff(createDateRange("2024-01-01", "2024-04-01"), "90");
        WaterTariff waterTariff2 = createWaterTariff(createDateRange("2024-04-01", "2025-01-01"), "100");

        ColdWaterSection coldWaterSection = generateColdWaterSection(
                createDateRange("2024-01-01", "2025-01-01"),
                createColdWaterSectionInputs(
                        List.of(waterTariff1, waterTariff2), List.of(meterReading1, meterReading2, meterReading3)));
        ...
        WaterFee coldWaterFee1 = coldWaterSection.priceList().getFirst();
        assertThat(coldWaterFee1.dateRange()).isEqualTo(createDateRange("2024-01-01", "2024-04-01"));
        assertThat(coldWaterFee1.unitAmount()).isEqualTo("90");
        ...
        assertThat(coldWaterFee2.dateRange()).isEqualTo(createDateRange("2024-04-01", "2024-06-01"));
        assertThat(coldWaterFee2.unitAmount()).isEqualTo("100");
        ...
        assertThat(coldWaterFee3.dateRange()).isEqualTo(createDateRange("2024-06-01", "2025-01-01"));
