...
public final class HtmlBuilder {
	...
	private HtmlBuilder appendTag(String tag, String text) {
		sb.append("<").append(tag).append(">").append(escape(text)).append("</").append(tag).append(">\n");
		return this;
	}

	private HtmlBuilder appendTag(String tag, String text, String clazz) {
		sb.append("<").append(tag).append(" class=\"").append(clazz).append("\">").append(escape(text)).append("</")
				.append(tag).append(">\n");
		return this;
	}
	...
	public HtmlBuilder beginSection(String title, int headingLevel) {
		...
		sb.append("<h").append(headingLevel).append(">").append(title).append("</h").append(headingLevel).append(">");
		return this;
	}
	...
	public HtmlBuilder totalRow(int colSpan, String label, BigDecimal value) {
		beginTr();
		if (colSpan > 1) {
			sb.append("<td colspan=\"").append(colSpan).append("\"><b>").append(label).append("</b></td>");
		} else {
			sb.append("<td><b>").append(label).append("</b></td>");
		}
		sb.append("<td class=\"total-money\">").append(formatter.formatMoney(value)).append("</td>");
		endTr();
		return this;
	}
