...
public record Report(DateRange dateRange, List<String> tenant, List<String> owner, String reportPlace,
		LocalDate reportDate, List<String> sources, List<ReportSection> sections, BigDecimal total) {
