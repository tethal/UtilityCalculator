...
public record HotWaterSectionInputs(String name, List<MeterReading> readings, List<WaterTariff> priceList,
		List<ServiceCost> heatingBasicCosts, List<WaterTariff> heatingConsumableTariffs) implements SectionInputs {
