...
public final class ParserUtil {
    ...
    public static List<String> preprocess(final String input) {
        return input.lines()
                .map(ParserUtil::normalizeLine)
    ...
    public static DateRange parseRange(final String text) {
        return DateRangeParser.parse(text);
    }

    public static StringDatePair parseStringDatePair(String line) {
    ...
    public record StringDatePair(String string, LocalDate date) {}

    public static GroupHeader parseGroupHeader(String line) {
