...
public class ColdWaterSectionGeneratorTest {
	...
	void coldWaterSection_withOneMeterId_should_haveCorrectColdWaterReading() {
		...
		ColdWaterSection coldWaterSection = generateColdWaterSection(createDateRange("2024-01-01", "2025-01-01"),
				createColdWaterSectionInputs(List.of(waterTariff),
	...
	void coldWaterSection_withOneMeterId_withMultipleTariff_should_haveCorrectColdWaterFee() {
		...
		ColdWaterSection coldWaterSection = generateColdWaterSection(createDateRange("2024-01-01", "2025-01-01"),
				createColdWaterSectionInputs(List.of(waterTariff2, waterTariff1),
	...
	void coldWaterSection_withMultipleMeters_withMisingReadings_withMultipleTariff_should_haveCorrectColdWaterFee() {
		...
		ColdWaterSection coldWaterSection = generateColdWaterSection(createDateRange("2024-01-01", "2025-01-01"),
				createColdWaterSectionInputs(List.of(waterTariff1, waterTariff2),
						List.of(meterReading1, meterReading2, meterReading3, meterReading4)));
