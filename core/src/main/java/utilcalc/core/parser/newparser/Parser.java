...
import static utilcalc.core.parser.newparser.util.ParserUtil.*;
...
import utilcalc.core.parser.newparser.util.GroupHeader;
import utilcalc.core.parser.newparser.util.LineReader;
...
public final class Parser {
    ...
    public static ReportInputs parse(String input) {
        try {
            List<String> lines = preprocess(input);
            return parseReportInputs(lines);
    ...
    private static ReportInputs parseReportInputs(List<String> lines) {
