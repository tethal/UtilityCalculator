...
public class HotWaterSectionGeneratorTest {
	...
	void hotWaterSection_withOneMeterId_should_haveCorrectWaterReading() {
		...
		WaterTariff waterTariff = createWaterTariff(createDateRange("2024-01-01", "2025-01-01"), "90");

		ServiceCost heatingBasicCost = createServiceCost(createDateRange("2024-01-01", "2025-01-01"), "8000");

		WaterTariff heatingConsumableTariffs = createWaterTariff(createDateRange("2024-01-01", "2025-01-01"), "90");

		HotWaterSection hotWaterSection = generateHotWaterSection(createDateRange("2024-01-01", "2025-01-01"),
				createHotWaterSectionInputs(List.of(meterReading1, meterReading2, meterReading3), List.of(waterTariff),
						List.of(heatingBasicCost), List.of(heatingConsumableTariffs)));
		...
		assertThat(waterReading1.dateRange()).isEqualTo(createDateRange("2024-01-01", "2024-06-01"));
		...
		assertThat(waterReading2.dateRange()).isEqualTo(createDateRange("2024-06-01", "2025-01-01"));
	...
	void hotWaterSection_withOneMeterId_withMissingReadings_should_haveCorrectWaterReading() {
		...
		WaterReading waterReading1 = hotWaterSection.readings().getFirst();
		assertThat(waterReading1.meterId()).isEqualTo("kitchen");
		assertThat(waterReading1.dateRange()).isEqualTo(createDateRange("2024-01-01", "2024-02-01"));
		...
		assertThat(waterReading2.meterId()).isEqualTo("kitchen");
		assertThat(waterReading2.dateRange()).isEqualTo(createDateRange("2024-02-01", "2024-06-01"));
		...
		assertThat(waterReading3.dateRange()).isEqualTo(createDateRange("2024-06-01", "2024-09-01"));
		...
		assertThat(waterReading4.dateRange()).isEqualTo(createDateRange("2024-09-01", "2025-01-01"));
	...
	void hotWaterSection_withReplaceMeter_should_haveCorrectWaterReading() {
		...
		HotWaterSection hotWaterSection = generateHotWaterSection(createDateRange("2024-01-01", "2025-01-01"),
				createHotWaterSectionInputs(List.of(meterReading1, meterReading2, meterReading3, meterReading4),
						List.of(waterTariff), List.of(heatingBasicCost), List.of(heatingConsumableTariffs)));
	...
	void hotWaterSection_withMultipleTariff_should_haveCorrectPriceList() {
		...
		WaterTariff waterTariff1 = createWaterTariff(createDateRange("2024-01-01", "2024-06-01"), "90");
		WaterTariff waterTariff2 = createWaterTariff(createDateRange("2024-06-01", "2025-01-01"), "100");
		...
		HotWaterSection hotWaterSection = generateHotWaterSection(createDateRange("2024-01-01", "2025-01-01"),
				createHotWaterSectionInputs(List.of(meterReading1, meterReading2, meterReading3),
						List.of(waterTariff1, waterTariff2), List.of(heatingBasicCost),
	...
	void hotWaterSection_withOneHeatingBasisCost_should_haveCorrectHeatingBasicParts() {
		...
		ServiceCost heatingBasicCost1 = createServiceCost(createDateRange("2024-01-01", "2025-01-01"), "8000");

		WaterTariff heatingConsumableTariffs = createWaterTariff(createDateRange("2024-01-01", "2025-01-01"), "90");

		HotWaterSection hotWaterSection = generateHotWaterSection(createDateRange("2024-01-01", "2025-01-01"),
				createHotWaterSectionInputs(List.of(meterReading1, meterReading2, meterReading3), List.of(waterTariff),
						List.of(heatingBasicCost1), List.of(heatingConsumableTariffs)));

		assertThat(hotWaterSection.name()).isEqualTo("Hot water");
		assertThat(hotWaterSection.heatingBasicParts().size()).isEqualTo(1);
		assertThat(hotWaterSection.totalAmount()).isEqualTo("17000.00");

		WaterHeatingBasicPart waterHeatingBasicPart = hotWaterSection.heatingBasicParts().getFirst();
		assertThat(waterHeatingBasicPart.dateRange()).isEqualTo(createDateRange("2024-01-01", "2025-01-01"));
	...
	void hotWaterSection_withTwoHeatingBasisCost_should_haveCorrectHeatingBasicParts() {
		...
		HotWaterSection hotWaterSection = generateHotWaterSection(createDateRange("2024-01-01", "2025-01-01"),
				createHotWaterSectionInputs(List.of(meterReading1, meterReading2, meterReading3), List.of(waterTariff),
						List.of(heatingBasicCost1, heatingBasicCost2), List.of(heatingConsumableTariffs)));

		assertThat(hotWaterSection.name()).isEqualTo("Hot water");
		assertThat(hotWaterSection.heatingBasicParts().size()).isEqualTo(2);
		assertThat(hotWaterSection.totalAmount()).isEqualTo("17091.67");

		WaterHeatingBasicPart waterHeatingBasicPart1 = hotWaterSection.heatingBasicParts().getFirst();
		assertThat(waterHeatingBasicPart1.dateRange()).isEqualTo(createDateRange("2024-01-01", "2024-02-01"));
		...
		WaterHeatingBasicPart waterHeatingBasicPart2 = hotWaterSection.heatingBasicParts().getLast();
		assertThat(waterHeatingBasicPart2.dateRange()).isEqualTo(createDateRange("2024-02-01", "2025-01-01"));
	...
	void hotWaterSection_withOneConsumableTariff_should_haveCorrectHeatingConsumableParts() {
		...
		ServiceCost heatingBasicCost = createServiceCost(createDateRange("2024-01-01", "2025-01-01"), "8772");
		...
		WaterHeatingConsumablePart waterHeatingConsumablePart1 = hotWaterSection.heatingConsumableParts().getFirst();
		assertThat(waterHeatingConsumablePart1.dateRange()).isEqualTo(createDateRange("2024-01-01", "2024-06-01"));
		...
		WaterHeatingConsumablePart waterHeatingConsumablePart2 = hotWaterSection.heatingConsumableParts().getLast();
		assertThat(waterHeatingConsumablePart2.dateRange()).isEqualTo(createDateRange("2024-06-01", "2025-01-01"));
	...
	void hotWaterSection_withTwoConsumableTariffs_should_haveCorrectHeatingConsumableParts() {
		...
		HotWaterSection hotWaterSection = generateHotWaterSection(createDateRange("2024-01-01", "2025-01-01"),
				createHotWaterSectionInputs(List.of(meterReading1, meterReading2, meterReading3), List.of(waterTariff),
						List.of(heatingBasicCost), List.of(heatingConsumableTariffs1, heatingConsumableTariffs2)));
		...
		WaterHeatingConsumablePart waterHeatingConsumablePart1 = hotWaterSection.heatingConsumableParts().getFirst();
		assertThat(waterHeatingConsumablePart1.dateRange()).isEqualTo(createDateRange("2024-01-01", "2024-02-01"));
		...
		WaterHeatingConsumablePart waterHeatingConsumablePart2 = hotWaterSection.heatingConsumableParts().get(1);
		assertThat(waterHeatingConsumablePart2.dateRange()).isEqualTo(createDateRange("2024-02-01", "2024-06-01"));
		...
		WaterHeatingConsumablePart waterHeatingConsumablePart3 = hotWaterSection.heatingConsumableParts().getLast();
		assertThat(waterHeatingConsumablePart3.dateRange()).isEqualTo(createDateRange("2024-06-01", "2025-01-01"));
