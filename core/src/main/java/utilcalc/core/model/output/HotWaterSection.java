...
public record HotWaterSection(String name, BigDecimal totalAmount, List<WaterReading> readings,
		List<WaterFee> priceList, List<WaterHeatingBasicPart> heatingBasicParts,
		List<WaterHeatingConsumablePart> heatingConsumableParts) implements ReportSection {
