...
class PdfGeneratorTest {
	...
	void generatePdf_should_return_non_empty_bytes_and_write_file() throws IOException {
		SectionInputs deposits = new DepositsSectionInputs("Přijaté zálohy",
				List.of(new Payment("leden - duben", BigDecimal.valueOf(4), BigDecimal.valueOf(3000)),
		...
		SectionInputs otherFees = new OtherFeeInputs("Ostatní poplatky",
				List.of(new ServiceCost(DateRange.fromInclusive(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 12, 31)),
						BigDecimal.valueOf(8772)),
						new ServiceCost(DateRange.fromInclusive(LocalDate.of(2025, 1, 1), LocalDate.of(2025, 12, 31)),
								BigDecimal.valueOf(8000))));

		SectionInputs heatingFees = new HeatingFeeInputs("Vytápění",
				List.of(new ServiceCost(DateRange.fromInclusive(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 12, 31)),
						BigDecimal.valueOf(8772)),
						new ServiceCost(DateRange.fromInclusive(LocalDate.of(2025, 1, 1), LocalDate.of(2025, 12, 31)),
								BigDecimal.valueOf(8000))));

		SectionInputs coldWaterFees = new ColdWaterSectionInputs("Studená voda",
				List.of(new MeterReading("Vodoměr 1", LocalDate.of(2024, 1, 1), BigDecimal.valueOf(120)),
				...
				List.of(new WaterTariff(DateRange.fromInclusive(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 12, 31)),
						BigDecimal.valueOf(50)),
						new WaterTariff(DateRange.fromInclusive(LocalDate.of(2025, 1, 1), LocalDate.of(2025, 12, 31)),
								BigDecimal.valueOf(55))));

		SectionInputs hotWaterFees = new HotWaterSectionInputs("Teplá voda",
				List.of(new MeterReading("Vodoměr T1", LocalDate.of(2024, 1, 1), BigDecimal.valueOf(300)),
		...
		ReportInputs inputs = new ReportInputs(dateRange, List.of("Jan Nájemník"), List.of("Karel Vlastník"), "Praha",
				LocalDate.now(), List.of("Faktury, podklady měření"),
