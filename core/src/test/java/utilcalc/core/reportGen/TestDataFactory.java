...
public class TestDataFactory {
	...
	public static ColdWaterSectionInputs createColdWaterSectionInputs(List<WaterTariff> waterTariffs,
	...
	public static HotWaterSectionInputs createHotWaterSectionInputs(List<MeterReading> readings,
			List<WaterTariff> priceList, List<ServiceCost> heatingBasicCost,
